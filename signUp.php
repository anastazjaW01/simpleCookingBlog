...
<html lang="en">
    ...
    <div class="container-fluid">
        ...
        <?php endif ?>
        <form action="<?= $root ?>registration_logic.php" enctype="multipart/form-data" method="POST">
            ...
            <div class="form1 form-floating mt-2">
                <input type="text" id="login" name="login" value="<?= $login ?>" onkeyup="disableButton()"   class="form-control border-success" placeholder="User01" >
            ...
            <div class="form1 form-floating mt-2 mb-2" >
                ...
                <button type="submit" class="btn btn-success col-12 mt-2 mb-1" id="logowanie" name="submit">Sign up</button>
